...
void BMS_Service_DisableHeater2(void);
void BMS_Service_EnableCharging(void);
void BMS_Service_DisableCharging(void);
void BMS_Service_EnableDischarging(void);
void BMS_Service_DisableDischarging(void);
void Telemetry_UpdateSyncCounterFromBytes(TelemetryData *telemetry, uint8_t *bytes);
...
#endif /* BMS_SERVICE_H */  // File: BMS_Service.c
// Created on: Jun 29, 2025
// Author: yomue
