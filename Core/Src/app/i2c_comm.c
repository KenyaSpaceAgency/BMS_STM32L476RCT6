        ...
        if (crc_computed != crc_received) {
            ...
            switch (cmd) {
                ...
                case CMD_ENABLE_HEATER_1:
                    Heater1_On();
                    Log_Message(BMS_MSG_LEVEL_INFO, "Heater 1 enabled");
                    break;
                case CMD_DISABLE_HEATER_1:
                    Heater1_Off();
                    Log_Message(BMS_MSG_LEVEL_INFO, "Heater 1 disabled");
                    break;
                case CMD_ENABLE_HEATER_2:
                    Heater2_On();
                    Log_Message(BMS_MSG_LEVEL_INFO, "Heater 2 enabled");
                    break;
                case CMD_DISABLE_HEATER_2:
                    Heater2_Off();
                    Log_Message(BMS_MSG_LEVEL_INFO, "Heater 2 disabled");
                    break;
                ...
                case CMD_ENABLE_DISCHARGING:
                    ...
                    Log_Message(BMS_MSG_LEVEL_INFO, "Discharging enabled");
                    break;
                ...
                case CMD_READ_TELEMETRY:
                {
                    ...
                    if (HAL_I2C_Slave_Transmit(&hi2c3, i2c3_tx_buffer, pos, 100) != HAL_OK) {
                        ...
                        Log_Message(BMS_MSG_LEVEL_INFO, "I2C3 TX success: RAM telemetry");
                    }
                    break;
                }
                ...
                case CMD_READ_FLASHED_TELEMETRY:
                {
                    ...
                    if (snapshot.crc != expected_crc || snapshot.version != TELEMETRY_VERSION) {
                        Log_Message(BMS_MSG_LEVEL_ERROR,
                                    "Invalid flashed telemetry: CRC 0x%04X != 0x%04X or version mismatch",
                    ...
                    if (HAL_I2C_Slave_Transmit(&hi2c3, i2c3_tx_buffer, pos, 100) != HAL_OK) {
                        ...
                        Log_Message(BMS_MSG_LEVEL_INFO, "I2C3 TX success: Flashed telemetry");
                    }
                    break;
                }
